...
class awz_kpworks extends CModule
{
	var $MODULE_ID = "awz.kpworks";
	var $MODULE_VERSION;
    ...
    public function __construct()
	{
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_KPWORKS_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_KPWORKS_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_KPWORKS_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_KPWORKS_INSTALL_TITLE'),
    ...
    function InstallEvents()
    {
        ...
        $eventManager->registerEventHandlerCompatible(
            ...
            $this->MODULE_ID, '\\Awz\\Kpworks\\Access\\Handlers', 'OnAfterUserUpdate'
        );
        $eventManager->registerEventHandlerCompatible(
            'main', 'OnAfterUserAdd',
            $this->MODULE_ID, '\\Awz\\Kpworks\\Access\\Handlers', 'OnAfterUserUpdate'
        ...
        $eventManager->registerEventHandlerCompatible(
            'crm', 'OnActivityAdd',
            $this->MODULE_ID, '\\Awz\\Kpworks\\Api\\Controller\\Works', 'onCrmActivityAdd'
        );
        return true;
    }
    ...
    {
        CopyDirFiles(
            $_SERVER['DOCUMENT_ROOT']."/bitrix/modules/".$this->MODULE_ID."/install/components/kpworks.config.permissions/",
            $_SERVER['DOCUMENT_ROOT']."/bitrix/components/awz/kpworks.config.permissions",
            true, true
        );
    ...
    {
        DeleteDirFilesEx("/bitrix/components/awz/kpworks.config.permissions");
        DeleteDirFiles(
    ...
    function createAgents() {
        CAgent::AddAgent(
            "\\Awz\\Kpworks\\Custom\\WorkAppLogTable::removeOldAgent();",
            $this->MODULE_ID,
            "N",
            21600);
        return true;
